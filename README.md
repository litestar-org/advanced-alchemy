...
- Integrated support for UUID6 and UUID7 (Native in Python 3.14+, [`uuid-utils`](https://github.com/aminalaee/uuid-utils) required for older versions, install with the `uuid` extra).
