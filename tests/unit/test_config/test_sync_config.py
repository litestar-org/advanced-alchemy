...
def test_post_init_routing_config_sets_connection_string() -> None:
    ...
    assert config.connection_config.connection_string == "sqlite:///routed"
...
def test_post_init_routing_config_fallback_to_engine_configs() -> None:
    ...
    config = SQLAlchemySyncConfig(routing_config=mock_routing)
    assert config.connection_config.connection_string == "sqlite:///fallback"
...
def test_post_init_without_cache_config_leaves_info_clean() -> None:
    ...
    config = SQLAlchemySyncConfig(connection_config=ConnectionConfig(connection_string="sqlite:///:memory:"))
...
def test_hash_distinguishes_configs_by_cache_manager() -> None:
    ...
    cfg_none = SQLAlchemySyncConfig(connection_config=ConnectionConfig(connection_string="sqlite:///:memory:"))
