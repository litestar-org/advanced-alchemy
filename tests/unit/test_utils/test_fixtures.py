...
class TestOpenFixture:
    ...
    def test_open_zipped_fixture_multiple_files(self, temp_fixtures_dir: Path, sample_data: "list[dict[str, Any]]") -> None:
    ...
    def test_open_zipped_fixture_preferred_name(self, temp_fixtures_dir: Path, sample_data: "list[dict[str, Any]]") -> None:
...
class TestOpenFixtureAsync:
    ...
    @pytest.mark.asyncio
    async def test_open_plain_json_fixture_async(self, temp_fixtures_dir: Path, sample_data: "list[dict[str, Any]]") -> None:
        """Test loading plain JSON fixture asynchronously."""
        result = await open_fixture_async(temp_fixtures_dir, "users")
        assert result == sample_data
    
    @pytest.mark.asyncio
    async def test_open_gzipped_fixture_async(self, temp_fixtures_dir: Path, sample_data: "list[dict[str, Any]]") -> None:
        """Test loading gzipped JSON fixture asynchronously."""
        result = await open_fixture_async(temp_fixtures_dir, "users_gz")
        assert result == sample_data
    
    @pytest.mark.asyncio
    async def test_open_zipped_fixture_async(self, temp_fixtures_dir: Path, sample_data: "list[dict[str, Any]]") -> None:
        """Test loading zipped JSON fixture asynchronously."""
        result = await open_fixture_async(temp_fixtures_dir, "users_zip")
        assert result == sample_data
    
    @pytest.mark.asyncio
    async def test_open_zipped_fixture_multiple_files_async(self, temp_fixtures_dir: Path, sample_data: "list[dict[str, Any]]") -> None:
    ...
    @pytest.mark.asyncio
    async def test_case_insensitive_support_async(self, temp_fixtures_dir: Path, sample_data: "list[dict[str, Any]]") -> None:
...
class TestIntegration:
    ...
    @pytest.mark.asyncio
    async def test_backward_compatibility_async(self, temp_fixtures_dir: Path, sample_data: "list[dict[str, Any]]") -> None:
