...
class TestSQLAlchemyRepository:
    ...
    async def test_service_count_method_with_filters(
        self, raw_authors: RawRecordData, author_service: AuthorService
    ) -> None:
    ...
    async def test_service_create_method(
        self, raw_authors: RawRecordData, author_service: AuthorService, author_model: AuthorModel
    ) -> None:
    ...
    async def test_service_update_method_data_is_dict(
        self, author_service: AuthorService, first_author_id: Any
    ) -> None:
    ...
    async def test_service_delete_where_method_empty(
        self, author_service: AuthorService, author_model: AuthorModel
    ) -> None:
    ...
    async def test_service_upsert_method(
        self, author_service: AuthorService, first_author_id: Any, author_model: AuthorModel, new_pk_id: Any
    ) -> None:
    ...
    async def test_service_create_method_slug(
        self, raw_slug_books: RawRecordData, slug_book_service: SlugBookService, slug_book_model: SlugBookModel
    ) -> None:
